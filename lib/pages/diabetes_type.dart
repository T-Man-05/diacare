...
class _DiabetesTypeScreen extends State<DiabetesTypeScreen> {
  ...
  void _validateAndContinue() {
    ...
    if (_selectedDiabetesType == null || _selectedDiabetesType!.isEmpty) {
      setState(() => _validationError = localizations
          .translate('onboarding.validation_diabetes_type_required'));
      return;
    }

    if (_selectedUnit == null || _selectedUnit!.isEmpty) {
      setState(() => _validationError =
          localizations.translate('onboarding.validation_unit_required'));
      return;
    }
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)
                            .translate('onboarding.diabetes_type'),
                        style: TextStyle(
                          fontFamily: 'Inter',
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            AppLocalizations.of(context)
                                .translate('onboarding.diabetes_type_hint'),
                            style: TextStyle(
                              color:
                          ...
                          items: [
                            DropdownMenuItem(
                                ...
                                child: Text(AppLocalizations.of(context)
                                    .translate('onboarding.diabetes_type_1'))),
                            DropdownMenuItem(
                                value: 'type2',
                                child: Text(AppLocalizations.of(context)
                                    .translate('onboarding.diabetes_type_2'))),
                            DropdownMenuItem(
                                value: 'gestational',
                                child: Text(AppLocalizations.of(context)
                                    .translate(
                                        'onboarding.diabetes_gestational'))),
                            DropdownMenuItem(
                                value: 'monogenic',
                                child: Text(AppLocalizations.of(context)
                                    .translate(
                                        'onboarding.diabetes_monogenic'))),
                            DropdownMenuItem(
                                value: 'secondary',
                                child: Text(AppLocalizations.of(context)
                                    .translate(
                                        'onboarding.diabetes_secondary'))),
                          ],
                          onChanged: (value) {
                      ...
                      Text(
                        AppLocalizations.of(context)
                            .translate('onboarding.unit_preferences'),
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontWeight: FontWeight.w500,
                          fontSize: labelFontSize,
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          hint: Text(
                            AppLocalizations.of(context)
                                .translate('onboarding.unit_preferences_hint'),
                            style: TextStyle(
                              color:
                                  isDark ? Colors.grey[500] : Colors.grey[400],
                            ),
                          ...
                          items: [
                            DropdownMenuItem(
                                value: 'mg_dl',
                                child: Text(AppLocalizations.of(context)
                                    .translate('onboarding.mg_dl'))),
                            DropdownMenuItem(
                                value: 'mmol_l',
                                child: Text(AppLocalizations.of(context)
                                    .translate('onboarding.mmol_l'))),
                          ],
                          onChanged: (value) {
